...
$(document).ready(function()
{
  ...
  var channels = ["JoshOG", "nurseos", "SolaryFortnite", "SCGTour", "GirlGamerChas"];  
/* Function for who is online */ 
function userOnline(channelName)
{
    $.getJSON("https://api.twitch.tv/kraken/streams?channel="+channels+"&client_id=e35gnrxztsw5nocsje75p93hlq4hkkn", function(json){ 
